...
public class Setp_Definition extends Base_Class {
	...
	public static void beforeHooks(Scenario s) throws Throwable {
		...
		if (s.isFailed()) {
			takeScreenShot(
					"E:\\Greens Tech Course\\seleninum\\eclipse-workspace\\Adactin_Hotel\\screenShot\\beforfailedHooks.png");
		}
	}
	...
	public static void afterHooks(Scenario s) throws Throwable {
		...
		if (s.isFailed()) {
			takeScreenShot(
					"E:\\Greens Tech Course\\seleninum\\eclipse-workspace\\Adactin_Hotel\\screenShot\\afterfailedHooks.png");
		}
	}
...
//		inputClear(pom.getHotel().getDateOut());
	...
	public void user_Click_The_Logout_Button_To_Logout_The_Our_Account() throws Throwable {
		takeScreenShot(
				"E:\\Greens Tech Course\\seleninum\\eclipse-workspace\\Adactin_Hotel\\screenShot\\cucumber_book_conform.png");
		sleep(2);
